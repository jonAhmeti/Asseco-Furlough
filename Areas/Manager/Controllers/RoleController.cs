...
namespace Furlough.Areas.Manager.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description")] DAL.Models.Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description")] DAL.Models.Role role)
        {
            if (id != role.Id)
            {
                return NotFound();
